...
**Important Note**: This document represents the state of the database schema *before* the implementation of PDF generation features. It should be used as the baseline for that development work.
...
*This documentation serves as the authoritative reference for all database-related development and should be updated whenever schema changes are made.*